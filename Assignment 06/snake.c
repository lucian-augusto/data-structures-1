...
int isTouchingBoundries(Point p) {
  if (p.x < 1 || p.x > SIZE - 1 || p.y < 1 || p.y > SIZE - 1) {
    return 1;
  }
  return 0;
}
  ...
  while (!finish(d)) {
    while ((!kbhit()) && (!finish(d))) {
      if (reverse) {
        Point p = getFront(d);
        if (pressionou_act == 'u') {
          d = insertFront(d, (Point){p.x - 1, p.y}, field);
        } else if (pressionou_act == 'd') {
          d = insertFront(d, (Point){p.x + 1, p.y}, field);
        } else if (pressionou_act == 'l') {
          d = insertFront(d, (Point){p.x, p.y - 1}, field);
        } else {
          d = insertFront(d, (Point){p.x, p.y + 1}, field);
        }
        ...
        Point p = getRear(d);
        if (pressionou_act == 'u') {
          d = insertRear(d, (Point){p.x - 1, p.y}, field);
        } else if (pressionou_act == 'd') {
          d = insertRear(d, (Point){p.x + 1, p.y}, field);
        } else if (pressionou_act == 'l') {
          d = insertRear(d, (Point){p.x, p.y - 1}, field);
        } else {
          d = insertRear(d, (Point){p.x, p.y + 1}, field);
        }
    ...
    if (!finish(d)) {
      ...
      if ((pressionou_act == 'd') && (pressionou_prv == 'u')) {
        reverse = !reverse;
      } else if ((pressionou_act == 'u') && (pressionou_prv == 'd')) {
        reverse = !reverse;
      } else if ((pressionou_act == 'l') && (pressionou_prv == 'r')) {
        reverse = !reverse;
      } else if ((pressionou_act == 'r') && (pressionou_prv == 'l')) {
        reverse = !reverse;
      }
    }
  }
